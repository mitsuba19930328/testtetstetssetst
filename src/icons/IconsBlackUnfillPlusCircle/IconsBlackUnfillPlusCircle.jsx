...
export const IconsBlackUnfillPlusCircle = ({ className }) => {
  return (
    <svg
      className={`icons-black-unfill-plus-circle ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_226_1357)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_226_1357">
